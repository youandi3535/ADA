...
def audience_profile(level: str) -> dict[str, Any]:
    ...
    profiles: dict[str, dict[str, Any]] = {
        "c_level": {
            ...
            "preferred_skeleton": ["Pyramid", "PSI"],
        ...
        "manager": {
            ...
            "preferred_skeleton": ["SCQA", "Comparative", "Diagnostic"],
        ...
        "analyst": {
            ...
            "preferred_skeleton": ["SCQA", "Analysis Standard", "Diagnostic"],
        ...
        "external_client": {
            ...
            "preferred_skeleton": ["PSI", "Analysis Standard"],
