...
_FIXED_PROPOSALS: list[dict[str, Any]] = [
    {
        ...
        "title": "PPT 프레젠테이션",
        "outputs": ["OUT-01"],
        "rationale": "핵심 분석 결과를 슬라이드로 요약 — 발표·공유에 최적.",
        "score": None,
    },
    {
        "id": 2,
        "title": "PDF 보고서",
        "outputs": ["OUT-02"],
        "rationale": "방법론·결과를 완전한 문서로 정리 — 인쇄·보관에 최적.",
        "score": None,
    },
    {
        "id": 3,
        "title": "발표 대본",
        "outputs": ["OUT-03"],
        "rationale": "슬라이드와 병행할 발표 해설 스크립트 제공.",
        "score": None,
    },
    {
        "id": 4,
        "title": "HTML 대시보드",
        "outputs": ["OUT-04"],
        "rationale": "인터랙티브 차트·필터 기반 웹 페이지 — 브라우저에서 바로 탐색.",
        "score": None,
    },
    {
        "id": 5,
        "title": "인사이트 요약",
        "outputs": ["OUT-07"],
        "rationale": "핵심 시사점을 Markdown 문서로 간결하게 정리.",
        "score": None,
    },
]
