...
ALL_AGENT_CLASSES = [
    SupervisorAgent,
    IntentElicitorAgent, DataProfilerAgent, SchemaValidatorAgent,
    AnalysisProposerAgent, MethodologyProposerAgent, ModelStrategyProposerAgent,
    ModelComparisonReporterAgent, OutputTypeSelectorAgent,
    PreprocessingStrategistAgent, FeatureEngineerAgent, EDAAgent, PreprocessingChoiceAgent,
    ModelSelectionAgent, HyperparameterTunerAgent, TrainingExecutorAgent,
    TrainingMonitorAgent, MetricsAggregatorAgent, FineTuneExecutorAgent,
    EvalAgent, ExplainabilityAgent, InsightAgent,
    ReportComposerAgent,
    SelfLearningAgent, AutoErrorHandlerAgent, SecurityGuardAgent,
    ErrorRecoveryAgent,
]
