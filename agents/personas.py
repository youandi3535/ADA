"""
28 에이전트 페르소나 권위 모듈 (HJ 2026-06-08: ReportArchitectAgent 추가).
...
assert len(PERSONAS) == 28, f"expected 28 personas, got {len(PERSONAS)}"
...
def list_agents_by_category() -> dict[str, list[str]]:
    ...
    return {
        ...
        "output": ["ReportArchitectAgent", "ReportComposerAgent"],
...
if __name__ == "__main__":
    ...
    assert total == len(PERSONAS) == 28
    print("✓ 페르소나 28종 자가 검증 통과")
