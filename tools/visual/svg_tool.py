...
_ICON_BY_SLIDE_ID: dict[str, str] = {
    ...
    "p2_pain": "triangle-alert",
    "p3_alt_limits": "octagon-x",
    "why_dl": "brain",
    ...
    "forecast_plot": "chart-line",
    "insights_derived": "key",
    "as_is_to_be": "shuffle",
    "i3_roi": "dollar-sign",
    "risk_mitigation": "shield-check",
    "roadmap": "map",
    "closing": "circle-check-big",
}

_ICON_BY_ROLE: dict[str, str] = {
    "claim": "target",
    "evidence": "chart-bar",
    "caveat": "triangle-alert",
    "action": "circle-arrow-right",
    "meta": "info",
